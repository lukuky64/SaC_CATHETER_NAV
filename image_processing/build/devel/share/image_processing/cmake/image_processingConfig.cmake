...
if("TRUE" STREQUAL "TRUE")
  set(image_processing_SOURCE_PREFIX /home/lukuky64/catkin_ws/src/sensors_and_control/image_processing)
  set(image_processing_DEVEL_PREFIX /home/lukuky64/catkin_ws/src/sensors_and_control/image_processing/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_processing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lukuky64/catkin_ws/src/sensors_and_control/image_processing/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lukuky64/catkin_ws/src/sensors_and_control/image_processing/build/devel/lib;/home/lukuky64/catkin_ws/devel/lib;/opt/ros/noetic/lib)
